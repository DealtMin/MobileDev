package ru.mirea.belkinaed.audiorecord;
...
import ru.mirea.belkinaed.audiorecord.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recordFilePath = (new File(getExternalFilesDir(Environment.DIRECTORY_MUSIC), "/audiorecordtest.mp3")).getAbsolutePath();
        Log.i("AAAAAA", recordFilePath);
