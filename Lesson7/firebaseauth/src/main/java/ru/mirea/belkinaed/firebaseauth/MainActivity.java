package ru.mirea.belkinaed.firebaseauth;
...
import ru.mirea.belkinaed.firebaseauth.databinding.ActivityMainBinding;
...
// Check if user is signed in (non-null) and update UI accordingly.
    ...
    private void updateUI(FirebaseUser user) {
        if (user != null) {
            ...
            binding.emailte.setVisibility(View.GONE);
            binding.passwordte.setVisibility(View.GONE);

            binding.verifyEmailButton.setVisibility(View.VISIBLE);
            binding.verifyEmailButton.setEnabled(!user.isEmailVerified());
            binding.outButton.setVisibility(View.VISIBLE);
            binding.outButton.setEnabled(true);
        } else {
            ...
            binding.outButton.setVisibility(View.GONE);
        }
    }
